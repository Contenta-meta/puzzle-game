...
export default function PuzzleCreate() {
  ...
  return (
    <div className="p-4 bg-gradient-to-b from-yellow-200 to-orange-100 min-h-screen">
      ...
      <div className="text-center py-6">
        <Button
          ...
          className="bg-green-400 hover:bg-green-500 text-white font-bold py-6 px-6 rounded-full text-lg inline-flex items-center gap-2 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-transform hover:scale-105"
